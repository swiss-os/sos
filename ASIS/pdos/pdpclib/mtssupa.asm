...
*                                                                    *
*  SPRINT, FREESPAC etc are documented here:                         *
*  http://www.bitsavers.org/pdf/univOfMichigan/mts/volumes/          *
*  MTSVol14-360370AssemblersInMTS-Sep1986.pdf                        *
*                                                                    *
*  And the actual system routines are documented here:               *
*  http://www.bitsavers.org/pdf/univOfMichigan/mts/volumes/          *
*  MTSVol03-SystemSubroutineDescriptions-Sep1989.pdf                 *
*                                                                    *
**********************************************************************
         COPY  PDPTOP
         PRINT GEN
