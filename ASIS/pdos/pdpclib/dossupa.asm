...
; Move this here so that we can define it as an external
; proc in dosstart.asm without masm complaining
public __exita
...
; untested and guessing:
;long _aFNalshl(long *a, unsigned int b)
