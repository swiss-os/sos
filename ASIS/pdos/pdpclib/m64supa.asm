...
# It appears that the oldest MacOS ARM64 version
# that can be targeted is 11.0 and that the argc
# and argv parameters are passed in registers on
# that version and beyond, rather than being on
# the stack.

#mov rdi,0
#mov rsi,rsp

# Note that this called _start() in linstart.c
# rather than __start() in start.c
