...
rem This option can be used to copy an object file
rem or executable off the system. Just modify pdpmus.m4
rem call runmus pdpmus.job output.txt none keep.dat
