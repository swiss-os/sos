...
#define COPY_SIGNED(struct_name, field_name, bytes) \
 bytearray_signed_read_##bytes##_bytes (&struct_name##_internal->field_name, struct_name##_file->field_name, endianess)
...
{
    const struct Elf64_Ehdr_file *Elf64_Ehdr_file = memory;

    COPY_CHAR_ARRAY (Elf64_Ehdr, e_ident);

    COPY(Elf64_Ehdr, e_type, 2);
    COPY(Elf64_Ehdr, e_machine, 2);
    COPY(Elf64_Ehdr, e_version, 4);
    COPY(Elf64_Ehdr, e_entry, 8);
    COPY(Elf64_Ehdr, e_phoff, 8);
    COPY(Elf64_Ehdr, e_shoff, 8);
    COPY(Elf64_Ehdr, e_flags, 4);
    COPY(Elf64_Ehdr, e_ehsize, 2);
    COPY(Elf64_Ehdr, e_phentsize, 2);
    COPY(Elf64_Ehdr, e_phnum, 2);
    COPY(Elf64_Ehdr, e_shentsize, 2);
    COPY(Elf64_Ehdr, e_shnum, 2);
    COPY(Elf64_Ehdr, e_shstrndx, 2);
}
...
{
    const struct Elf64_Shdr_file *Elf64_Shdr_file = memory;

    COPY(Elf64_Shdr, sh_name, 4);
    COPY(Elf64_Shdr, sh_type, 4);
    COPY(Elf64_Shdr, sh_flags, 8);
    COPY(Elf64_Shdr, sh_addr, 8);
    COPY(Elf64_Shdr, sh_offset, 8);
    COPY(Elf64_Shdr, sh_size, 8);
    COPY(Elf64_Shdr, sh_link, 4);
    COPY(Elf64_Shdr, sh_info, 4);
    COPY(Elf64_Shdr, sh_addralign, 8);
    COPY(Elf64_Shdr, sh_entsize, 8);
}
...
{
    const struct Elf64_Sym_file *Elf64_Sym_file = memory;

    COPY(Elf64_Sym, st_name, 4);
    COPY(Elf64_Sym, st_info, 1);
    COPY(Elf64_Sym, st_other, 1);
    COPY(Elf64_Sym, st_shndx, 2);
    COPY(Elf64_Sym, st_value, 8);
    COPY(Elf64_Sym, st_size, 8);
}
...
{
    const struct Elf64_Rel_file *Elf64_Rel_file = memory;
    
    COPY(Elf64_Rel, r_offset, 8);
    COPY(Elf64_Rel, r_info, 8);
}
...
void read_struct_Elf32_Rela (struct Elf32_Rela_internal *Elf32_Rela_internal, const void *memory, int endianess)
{
    ...
    COPY_SIGNED(Elf32_Rela, r_addend, 4);
}

void read_struct_Elf64_Rela (struct Elf64_Rela_internal *Elf64_Rela_internal, const void *memory, int endianess)
{
    const struct Elf64_Rela_file *Elf64_Rela_file = memory;
    
    COPY(Elf64_Rela, r_offset, 8);
    COPY(Elf64_Rela, r_info, 8);
    COPY_SIGNED(Elf64_Rela, r_addend, 8);
}
...
{
    const struct Elf64_Phdr_file *Elf64_Phdr_file = memory;

    COPY(Elf64_Phdr, p_type, 4);
    COPY(Elf64_Phdr, p_flags, 4);
    COPY(Elf64_Phdr, p_offset, 8);
    COPY(Elf64_Phdr, p_vaddr, 8);
    COPY(Elf64_Phdr, p_paddr, 8);
    COPY(Elf64_Phdr, p_filesz, 8);
    COPY(Elf64_Phdr, p_memsz, 8);
    COPY(Elf64_Phdr, p_align, 8);
}
...
{
    struct Elf64_Ehdr_file *Elf64_Ehdr_file = memory;
...
{
    struct Elf64_Shdr_file *Elf64_Shdr_file = memory;
...
{
    struct Elf64_Sym_file *Elf64_Sym_file = memory;
...
{
    struct Elf64_Rel_file *Elf64_Rel_file = memory;
...
{
    struct Elf64_Rela_file *Elf64_Rela_file = memory;
    
    COPY(Elf64_Rela, r_offset, 8);
    COPY(Elf64_Rela, r_info, 8);
    COPY(Elf64_Rela, r_addend, 8);
}
...
{
    struct Elf64_Phdr_file *Elf64_Phdr_file = memory;
