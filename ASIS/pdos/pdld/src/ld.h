...
#define mainframe_get_rmode mfgrmode
...
#define mainframe_symbol_name_prepare mfsnp
#define mainframe_get_long_options mfglopts
...
#define elf_get_first_section_rva elfgfsrva
#define elf_get_long_options elfgloptions

#define xmit_calculate_segments xmcsegs
#define xmit_calculate_start xmcstart
#define xmit_calculate_end xmcend

#define xmit_write_segments xmwsegs
#define xmit_write_start xmwstart
#define xmit_write_end xmwend
#endif /* SHORT_NAMES */
...
enum {
    ...
    RELOC_TYPE_PC32_FRSHIFT1,
    RELOC_TYPE_PC16_FRSHIFT1,
    ...
    RELOC_TYPE_LOONGARCH_B16,
    RELOC_TYPE_LOONGARCH_B21,
    RELOC_TYPE_LOONGARCH_B26,
    RELOC_TYPE_LOONGARCH_PCALA_HI20,
    RELOC_TYPE_LOONGARCH_PCALA_LO12,
...
#if 1
/* Currently case should be dropped and symbol names truncated for all mainframe linking. */
#define less_strict_mainframe_matching \
