...
/* Note that ARM/M68K/MF32 should probably start using the new
   NOSTDCALL */
#if defined(__ARM__) || defined(__M68K__) || defined(__MF32__) \
    || defined(__NOSTDCALL__)
#define __stdcall
#endif
...
#define WINAPI
#elif defined(__HALFEXP__) /* half-hearted export */
...
#ifdef __SHORTNAMES__
#define GetConsoleScreenBufferInfo GCSBI
#define GetConsoleMode GCMode
#define GetConsoleCP GCCP
#define GetConsoleCursorInfo GCCInfo
#define GetConsoleWindow GCWindow
#define GetConsoleTitleA GCTitA
#define SetHandleInformation SetHanInfo
#define SetHandleCount SetHCount
#define SetConsoleCtrlHandler SetCCH
#define SetConsoleMode SetCMode
#define SetConsoleCursorInfo SCCInfo
#define SetConsoleCursorPosition SCCPos
#define SetConsoleTextAttribute SCTAttr
#define SetConsoleTitleW SCTitW
#define SetConsoleTitleA SCTitA
#define GetSystemTime GSTime
#define GetSystemTimeAsFileTime GSTAFTime
#define GetSystemDirectoryW GSDirW
#define GetSystemInfo GSInfo
#define GetSystemWindowsDirectoryW GSWDirW
#define GetSystemWow64DirectoryW GSWow64DW
#define GetCurrentDirectoryA GCurDA
#define GetCurrentProcess GCProc
#define GetCurrentProcessId GCPId
#define GetCurrentThread GCThread
#define GetCurrentThreadId GCTId
#define GetModuleHandleA GMHanA
#define GetModuleFileNameA GMFNamA
#define GetModuleFileNameW GMFNamW
#define GetModuleHandleExW GMHExW
#define GetModuleHandleW GMHanW
#define GetEnvironmentStringsA GEStrA
#define GetEnvironmentStringsW GEStrW
#define GetEnvironmentVariableA GEVarA
#define GetEnvironmentVariableW GEVarW
#define SetThreadAffinityMask STAffMask
#define SetThreadContext STContext
#define SetThreadPriority STPriority
#define ReadFile RdFile
#define ReadFileEx RdFEx
#define WriteFile WrFile
#define WriteFileEx WrFEx
#define ReadConsoleInputA RCInA
#define ReadConsoleInputW RCInW
#define ReadConsoleOutputW RCOutW
#define FileTimeToLocalFileTime FTTLFT
#define FileTimeToSystemTime FTTST
#define LoadLibraryA LLA
#define LoadLibraryExA LLExA
#define LoadLibraryExW LLExW
#define LoadLibraryW LLibW
#define WriteConsoleOutputA WCOutA
#define WriteConsoleOutputW WCOutW
#define WriteConsoleW WConW
#define SetEnvironmentVariableW SEVarW
#define SetEnvironmentVariableA SEVarA
#define LCMapStringW LCMSW
#define LCMapStringA LCMSA
#define GetStringTypeA GSTypA
#define GetStringTypeW GSTypW
#define GetLocaleInfoA GLeInfA
#define GetLocaleInfoW GLoInfW
#define GetLocalTime GLocTime
#define CompareStringW CmpStrW
#define CompareStringA CompStrA
#define VirtualQuery VirQuery
#define VirtualQueryEx VirQEx
#define VirtualProtect VirProt
#define VirtualProtectEx VirPEx
#define TerminateProcess TerProc
#define TerminateThread TerThread
#define SetTapeParameters STParms
#define SetTapePosition STPosition
#define SetFilePointer SFPointer
#define SetFilePointerEx SFPEx
#define QueryPerformanceCounter QPCounter
#define QueryPerformanceFrequency QPFrequency
#define PeekConsoleInputW PCInpW
#define PeekConsoleInputA PCInpA
#define MapViewOfFile MVOFile
#define MapViewOfFileEx MVOFEx
#define IsProcessInJob IsProcInJob
#define IsProcessorFeaturePresent IPFeatP
#define GetVersion GetVrs
#define GetVersionExA GetVExA
#define GetThreadContext GThrContext
#define GetThreadPriority GTPriority
#define GetTapeParameters GTParms
#define GetTapePosition GTPosition
#define GetStartupInfoA GStInfA
#define GetStartupInfoW GSInfoW
#define GetNumberOfConsoleMouseButtons GNOCMB
#define GetNumberOfConsoleInputEvents GNOCIE
#define GetLogicalDriveStringsA GLDrvStrA
#define GetLogicalDrives GLDroves
#define GetFileTime GFTime
#define GetFileType GFType
#define GetFileSize GFSize
#define GetFileSizeEx GFSEx
#define GetExitCodeProcess GECProc
#define GetExitCodeThread GECThread
#define GetComputerNameA GCmpNamA
#define GetComputerNameW GCompNameW
#define GetCommandLineA GCLineA
#define GetCommandLineW GCmdLineW
#define FreeEnvironmentStringsA FrEnvStrA
#define FreeEnvironmentStringsW FreeEnvStrW
#define FindNextFileA FNextFileA
#define FindNextVolumeW FNVolW
#define FindFirstFileA FFFilA
#define FindFirstVolumeW FFVolW
#define FillConsoleOutputAttribute FConsOutAttrib
#define FillConsoleOutputCharacterA FCOutCharA
#define CreateProcessA CrProcA
#define CreateProcessW CrPrcW
#define CreateFileA CrFilA
#define CreateFileW CrFilW
#define ClearCommError ClrComErr
#define ClearCommBreak ClrCBreak
#endif
