...
#define PosGetDefaultDrive PosGDD
#define PosGetDeviceInformation PosGDI
#define PosAbsoluteDriveRead PosADR
#define PosAbsoluteDriveWrite PosADW
#define PosAbsoluteDiskRead PosADiR
#define PosAbsoluteDiskWrite PosADskW
#define PosKeyboardHit PosKybHit
#define PosKeyboardMap PosKbMap
#define PosVirtualAlloc PosVAlloc
#define PosVirtualFree PosVFree
#define PosSetVideoAttribute PosSVA
#define PosSetVideoMode PosSVM
#define PosSetVideoPage PosSVP
#define PosAllocMemPages PosAMP
#define PosAllocMem PosAlMem
#define PosProcessGetMemoryStats PosPrGMS
#define PosProcessGetInfo PosPGetInf
#define PosDisplayOutput PosDOutput
#define PosDisplayString PosDString
#define PosDisplayInteger PosDInteger
#define PosCreatFile PosCrFile
#define PosCreatNewFile PosCNewFile
#define PosSetFileAttributes PosSFAttr
#define PosSetFileLastWrittenDateAndTime PosSFLWDAT
#define PosGetFileAttributes PosGFAttr
#define PosGetFileLastWrittenDateAndTime PosGFLWDAT
#define PosGetCurDir PosGCDir
#define PosGetCurrentProcessId PosGCProcId
#define PosTerminateAndStayResident PosTASR
#define PosTerminate PosTrmnt
#define PosBlockDeviceRemovable PosBDRmv
#define PosBlockDeviceRemote PosBDevRemote
#define PosDirectConsoleOutput PosDirConsOutput
#define PosDirectCharInputNoEcho PosDCharInNE
#define PosGetCommandLine2 PosGC2
#endif
...
/* unclear why we need an alternative */
char *PosGetCommandLine2(void);
...
#define POS_MAX_PATT 16
#define DTA_SEARCH 11
#define DTA_FILENAME 13
#define DTA_LFN 256
...
typedef struct {
    ...
    char search[DTA_SEARCH]; /*search name used(0x02)*/
    ...
    char file_name[DTA_FILENAME]; /*ASCIIZ file name and extension in
                          form NAME.EXT with blanks stripped
                          0x1E)*/
    unsigned char lfn[DTA_LFN]; /*Stores LFN (255 characters max.) and
                                *null terminator.*/
